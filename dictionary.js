...
const DICTIONARY_DATA = {
  ...
  "buenas tardes": {
    ...
    synonyms: [], derived: ["tarde（午後、遅い）"],
    dialogue: { es: "— Buenas tardes, ¿en qué le puedo ayudar?\n— Buenas tardes, busco una camisa.", ja: "「こんにちは、何かお手伝いできますか」「こんにちは、シャツを探しています」" } },
  "buenas noches": {
    nuance: "日没後の挨拶「こんばんは」と、寝る前の「おやすみ」の両方に使える便利な表現。",
    etymology: "bueno（良い）+ noche（夜）の組み合わせ。",
    synonyms: [], derived: ["noche（夜）"],
    dialogue: { es: "— Buenas noches, que duermas bien.\n— Igualmente, hasta mañana.", ja: "「おやすみ、よく眠ってね」「あなたもね、また明日」" } },
  "¿cómo estás?": {
    nuance: "友人・親しい相手への「元気？」。目上の人にはformalな¿Cómo está usted?を使う。",
    etymology: "cómo（どのように）+ estar（一時的な状態）の組み合わせ。",
    synonyms: ["¿qué tal?（もっとカジュアル）"],
    derived: [],
    dialogue: { es: "— ¿Cómo estás hoy?\n— Bien, gracias, ¿y tú?", ja: "「今日は元気？」「元気だよ、ありがとう、君は？」" } },
  "mucho gusto": {
    nuance: "初対面のときの決まり文句「はじめまして」。encantado/encantadaも同じ場面で使える（性別で語尾が変わる）。",
    etymology: "mucho（たくさんの）+ gusto（喜び）で「大変うれしいです」が直訳。",
    synonyms: ["encantado/encantada（会えて光栄です）"],
    derived: ["gustar（好きだ）"],
    dialogue: { es: "— Soy Ana, mucho gusto.\n— Mucho gusto, Ana, soy Carlos.", ja: "「アナです、はじめまして」「はじめまして、アナさん、カルロスです」" } },
  "hasta luego": {
    nuance: "「またね」。adiósよりカジュアルで、また会う予定がある相手によく使う。",
    etymology: "hasta（〜まで）+ luego（後で）の組み合わせ。",
    synonyms: ["nos vemos（またね）", "hasta pronto（また近いうちに）"],
    derived: [],
    dialogue: { es: "— Me tengo que ir, hasta luego.\n— Hasta luego, cuídate.", ja: "「もう行かなきゃ、またね」「またね、気をつけて」" } },
  "adiós": {
    nuance: "「さようなら」。長期間・二度と会わないかもしれないニュアンスがあり、hasta luegoより重みがある。",
    etymology: "a Dios（神へ、神に委ねて）が縮まった表現。",
    synonyms: [], derived: [],
    dialogue: { es: "— Bueno, ya me voy, adiós.\n— Adiós, que te vaya bien.", ja: "「じゃあ、もう行くね、さようなら」「さようなら、うまくいくといいね」" } },
  "¿qué tal?": {
    nuance: "友人へのカジュアルな挨拶「調子どう？」。¿Qué tal el fin de semana?（週末どうだった？）のように話題を続けて聞くのにも使える。",
    etymology: "qué（何）+ tal（そのような）の組み合わせ。",
    synonyms: ["¿qué onda?（メキシコの口語）"],
    derived: [],
    dialogue: { es: "— ¿Qué tal tu día?\n— Bastante bien, gracias.", ja: "「今日はどうだった？」「かなり良かったよ、ありがとう」" } },
  "uno": {
    nuance: "数字の「1」。名詞の前で使うときはun/unaに変化する（un libro、una casa）。",
    etymology: "ラテン語unus（一つの）に由来。",
    synonyms: [], derived: ["único（唯一の）", "unir（結びつける）"],
    dialogue: { es: "— ¿Cuántos hermanos tienes?\n— Solo uno.", ja: "「兄弟は何人いる？」「一人だけだよ」" } },
  "dos": {
    nuance: "数字の「2」。性・数変化しない数詞（unoだけ特別）。",
    etymology: "ラテン語duo（二つの）に由来。",
    synonyms: [], derived: ["doble（二倍の）", "docena（1ダース）"],
    dialogue: { es: "— Quiero dos boletos, por favor.\n— Claro, son 200 pesos.", ja: "「チケットを2枚ください」「かしこまりました、200ペソです」" } },
  "tres": {
    nuance: "数字の「3」の基本語。",
    etymology: "ラテン語tres（三つの）に由来。",
    synonyms: [], derived: ["tercero（3番目の）", "triple（三倍の）"],
    dialogue: { es: "— Llegaré en tres minutos.\n— Perfecto, te espero.", ja: "「3分で着くよ」「わかった、待ってるね」" } },
  "cuatro": {
    nuance: "数字の「4」の基本語。",
    etymology: "ラテン語quattuor（四つの）に由来。",
    synonyms: [], derived: ["cuarto（4番目の、部屋）", "cuadrado（正方形）"],
    dialogue: { es: "— Somos cuatro en mi familia.\n— Qué bien, nosotros somos tres.", ja: "「私の家族は4人だよ」「いいね、私たちは3人だよ」" } },
  "cinco": {
    nuance: "数字の「5」の基本語。",
    etymology: "ラテン語quinque（五つの）に由来。",
    synonyms: [], derived: ["quinto（5番目の）"],
    dialogue: { es: "— Nos vemos a las cinco.\n— Perfecto, ahí estaré.", ja: "「5時に会おう」「わかった、そこにいるよ」" } },
  "diez": {
    nuance: "数字の「10」の基本語。切りの良い数として色々な表現に使われる。",
    etymology: "ラテン語decem（十）に由来。",
    synonyms: [], derived: ["décimo（10番目の）", "década（10年間）"],
    dialogue: { es: "— ¿Cuántos años llevas aquí?\n— Diez años ya.", ja: "「ここに来てどれくらい？」「もう10年になるよ」" } },
  "veinte": {
    nuance: "数字の「20」の基本語。21以降はveintiuno, veintidósのように1語につながる。",
    etymology: "ラテン語viginti（二十）に由来。",
    synonyms: [], derived: ["veintena（20個くらい）"],
    dialogue: { es: "— Tengo veinte años.\n— Eres muy joven todavía.", ja: "「20歳なんだ」「まだとても若いね」" } },
  "cien": {
    nuance: "数字の「100」。ちょうど100のときはcien、101以降はciento uno等になる（cien→ciento）。",
    etymology: "ラテン語centum（百）に由来。",
    synonyms: [], derived: ["centenar（100個くらい）", "por ciento（パーセント）"],
    dialogue: { es: "— Esto cuesta cien pesos.\n— Está bien, aquí tienes.", ja: "「これは100ペソです」「わかりました、どうぞ」" } },
  "mil": {
    nuance: "数字の「1000」。「un mil」とは言わず、単にmilと言う（他の数字は「un millón」のようにunをつける）。",
    etymology: "ラテン語mille（千）に由来。",
    synonyms: [], derived: ["milenio（千年紀）", "miles（何千もの）"],
    dialogue: { es: "— Ahorré mil pesos este mes.\n— ¡Qué disciplina!", ja: "「今月1000ペソ貯金したよ」「なんて計画的なんだ！」" } },
  "lunes": {
    nuance: "「月曜日」。スペイン語の曜日は小文字で書き、性別はすべて男性名詞（el lunes）。",
    etymology: "ラテン語lunae dies（月の日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— ¿Trabajas los lunes?\n— Sí, de lunes a viernes.", ja: "「月曜日は働いてるの？」「うん、月曜から金曜まで」" } },
  "martes": {
    nuance: "「火曜日」。martes y trece（13日の火曜日）はスペイン語圏で英語の「13日の金曜日」に相当する縁起の悪い日とされる。",
    etymology: "ラテン語Martis dies（軍神マルスの日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— ¿Tienes clase los martes?\n— Sí, tengo clase de español.", ja: "「火曜日は授業ある？」「うん、スペイン語の授業があるよ」" } },
  "miércoles": {
    nuance: "「水曜日」。週の真ん中の日として、日本語の「週の中日」に近い感覚で使われることもある。",
    etymology: "ラテン語Mercurii dies（商業神メルクリウスの日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— Ya es miércoles, la semana va rápido.\n— Sí, ya casi es viernes.", ja: "「もう水曜日だね、一週間があっという間」「うん、もうすぐ金曜日だね」" } },
  "jueves": {
    nuance: "「木曜日」。特に慣用表現は少ないが、週末前日として楽しみにされる曜日。",
    etymology: "ラテン語Iovis dies（主神ユピテルの日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— ¿Qué haces el jueves?\n— Todavía no tengo planes.", ja: "「木曜日は何するの？」「まだ予定がないよ」" } },
  "viernes": {
    nuance: "「金曜日」。¡Por fin viernes!（やっと金曜日！）のように、週末の始まりとして喜ばれる曜日。",
    etymology: "ラテン語Veneris dies（美の女神ウェヌスの日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— ¡Por fin es viernes!\n— Sí, ya quiero que sea fin de semana.", ja: "「やっと金曜日だ！」「うん、もう週末になってほしいよ」" } },
  "sábado": {
    nuance: "「土曜日」。週末の代表的な曜日で、パーティーや外出の予定によく使われる。",
    etymology: "ヘブライ語shabbat（安息日）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— ¿Tienes planes para el sábado?\n— Sí, voy a una fiesta.", ja: "「土曜日の予定は？」「うん、パーティーに行くよ」" } },
  "domingo": {
    nuance: "「日曜日」。多くのスペイン語圏の国で、家族で集まって食事をする日として大切にされている。",
    etymology: "ラテン語dies dominicus（主の日）に由来。",
    synonyms: [], derived: ["dominical（日曜の）"],
    dialogue: { es: "— Los domingos como con mi familia.\n— Qué lindo, nosotros también.", ja: "「日曜日は家族と食事をするんだ」「素敵だね、私たちもだよ」" } },
  "la primavera": {
    nuance: "「春」。花や新しい始まりを連想させる季節として、比喩的にも「若さ」の意味で使われることがある。",
    etymology: "ラテン語primus（最初の）+ ver（春）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— Me encanta la primavera.\n— A mí también, las flores son hermosas.", ja: "「春が大好きなんだ」「私もだよ、花がきれいだよね」" } },
  "el verano": {
    nuance: "「夏」。メキシコを含む多くの地域で、学校の長期休みの時期でもある。",
    etymology: "ラテン語veranum（春に関する、後に夏の意味に転じた）に由来。",
    synonyms: [], derived: ["veranear（避暑に行く）"],
    dialogue: { es: "— ¿Qué planes tienes para el verano?\n— Voy a viajar con mi familia.", ja: "「夏の予定は？」「家族と旅行するつもりだよ」" } },
  "el otoño": {
    nuance: "「秋」。メキシコの死者の日(11月上旬)もこの季節の終わりごろに祝われる。",
    etymology: "ラテン語autumnus（秋）に由来。",
    synonyms: [], derived: ["otoñal（秋の）"],
    dialogue: { es: "— El otoño es mi estación favorita.\n— ¿Por qué te gusta tanto?", ja: "「秋が一番好きな季節なんだ」「どうしてそんなに好きなの？」" } },
  "el invierno": {
    nuance: "「冬」。メキシコの多くの地域は温暖なため、日本ほど寒くならないことも多い。",
    etymology: "ラテン語hibernum（冬の）に由来。",
    synonyms: [], derived: ["invernal（冬の）", "invernadero（温室）"],
    dialogue: { es: "— En invierno hace mucho frío aquí.\n— ¿De verdad? Pensé que México era cálido.", ja: "「ここは冬とても寒いんだ」「本当に？メキシコは暖かいと思っていたよ」" } },
  "verde": {
    nuance: "「緑」の基本語。estar verde（未熟である）という慣用表現もある。",
    etymology: "ラテン語viridis（緑の）に由来。",
    synonyms: [], derived: ["verdura（野菜）", "verdor（緑の生い茂り）"],
    dialogue: { es: "— Me gusta el color verde.\n— A mí también, es relajante.", ja: "「緑色が好きなんだ」「私もだよ、落ち着くよね」" } },
  "amarillo": {
    nuance: "「黄色」の基本語。メキシコのタクシーなど、黄色が使われる場面も多い。",
    etymology: "俗ラテン語amarellus（少し苦い→黄色っぽい、の意味変化）に由来。",
    synonyms: [], derived: ["amarillento（黄色っぽい）"],
    dialogue: { es: "— Esa flor amarilla es bonita.\n— Sí, es un girasol.", ja: "「あの黄色い花きれいだね」「うん、ひまわりだよ」" } },
  "negro": {
    nuance: "「黒」の基本語。mercado negro（闇市場）のような比喩表現にも使われる。",
    etymology: "ラテン語niger（黒い）に由来。",
    synonyms: [], derived: ["negrura（黒さ）", "ennegrecer（黒くする）"],
    dialogue: { es: "— Voy a usar el vestido negro.\n— Te va a quedar muy bien.", ja: "「黒いワンピースを着るつもり」「すごく似合うと思うよ」" } },
  "blanco": {
    nuance: "「白」の基本語。en blanco（真っ白、頭が真っ白になる）という慣用表現もある。",
    etymology: "ゲルマン語系の語blank（輝く）に由来。",
    synonyms: [], derived: ["blancura（白さ）", "blanquear（白くする）"],
    dialogue: { es: "— Me quedé en blanco durante el examen.\n— Te entiendo, a mí me pasa igual.", ja: "「試験中、頭が真っ白になっちゃった」「わかるよ、私も同じことがあるよ」" } },
  "gris": {
    nuance: "「灰色」の基本語。天気が曇っているときにも使われる（un día gris＝どんよりした日）。",
    etymology: "ゲルマン語系の語gris（灰色）に由来。",
    synonyms: [], derived: ["grisáceo（灰色がかった）"],
    dialogue: { es: "— El cielo está muy gris hoy.\n— Sí, parece que va a llover.", ja: "「今日は空がとても曇っているね」「うん、雨が降りそうだね」" } },
  "rosa": {
    nuance: "「ピンク」の意味と「バラの花」の両方の意味を持つ単語。文脈で判断する。",
    etymology: "ラテン語rosa（バラ）に由来、花の色から色名に転じた。",
    synonyms: ["rosado（より一般的なピンクの形容詞形）"],
    derived: ["rosado（ピンク色の）", "rosal（バラの木）"],
    dialogue: { es: "— Me regaló una rosa.\n— Qué romántico.", ja: "「バラをプレゼントしてくれたんだ」「なんてロマンチックなんだ」" } },
  "morado": {
    nuance: "「紫」の基本語。violeta（バイオレット）とほぼ同義で使われることも多い。",
    etymology: "mora（桑の実）の色に由来。",
    synonyms: ["violeta（紫、バイオレット）", "púrpura（紫、より濃い）"],
    derived: [],
    dialogue: { es: "— Ese suéter morado te queda bien.\n— Gracias, es mi color favorito.", ja: "「その紫のセーター似合っているね」「ありがとう、お気に入りの色なんだ」" } },
  "naranja": {
    nuance: "「オレンジ色」と「オレンジ(果物)」の両方の意味を持つ単語。色を表すときは性数変化しない（unas camisas naranja）。",
    etymology: "アラビア語経由でペルシャ語nārang（オレンジの実）に由来。",
    synonyms: [], derived: ["anaranjado（オレンジ色の、別の言い方）"],
    dialogue: { es: "— Me gusta el atardecer naranja.\n— Es hermoso, sobre todo en la playa.", ja: "「オレンジ色の夕焼けが好きなんだ」「美しいよね、特にビーチでは」" } },
  "marrón": {
    nuance: "「茶色」の基本語。café（コーヒー色）もラテンアメリカでは茶色の意味でよく使われる。",
    etymology: "フランス語marron（マロン、栗）に由来。",
    synonyms: ["café（茶色、ラテンアメリカで）"],
    derived: [],
    dialogue: { es: "— Tiene los ojos marrones.\n— Son muy bonitos.", ja: "「彼女は茶色い目をしているよ」「とてもきれいだね」" } },
  "dorado": {
    nuance: "「金色」の基本語。動詞dorar（金色にする、こんがり焼く）の過去分詞から形容詞化した語。",
    etymology: "dorar（金色にする）の過去分詞、ラテン語deaurare（金メッキする）に由来。",
    synonyms: [], derived: ["dorar（金色にする、こんがり焼く）"],
    dialogue: { es: "— Tiene un reloj dorado precioso.\n— Sí, se ve muy elegante.", ja: "「素敵な金色の時計をしているね」「うん、とてもエレガントに見えるね」" } },
  "plateado": {
    nuance: "「銀色」の基本語。platear（銀メッキする）の過去分詞から形容詞化した語。",
    etymology: "plata（銀）から派生した語。",
    synonyms: [], derived: ["plata（銀）", "platear（銀メッキする）"],
    dialogue: { es: "— Me encantan tus aretes plateados.\n— Gracias, fueron un regalo.", ja: "「その銀色のピアス素敵だね」「ありがとう、プレゼントでもらったんだ」" } },
  "celeste": {
    nuance: "「水色」。cielo（空）と同語源で、空の色を表す語として使われる。",
    etymology: "ラテン語caelestis（天の、空の）に由来。",
    synonyms: ["azul cielo（空色）"],
    derived: ["cielo（空）"],
    dialogue: { es: "— El vestido celeste es muy delicado.\n— Sí, combina bien contigo.", ja: "「その水色のワンピースはとても繊細だね」「うん、君によく似合っているよ」" } },
  "turquesa": {
    nuance: "「ターコイズ色」。宝石ターコイズ(トルコ石)の色から来た語。カリブ海の海の色を表現するのにもよく使われる。",
    etymology: "フランス語turquoise（トルコの、トルコ石）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— El mar aquí es de un turquesa increíble.\n— Sí, parece una postal.", ja: "「ここの海は信じられないくらいターコイズ色だね」「うん、まるで絵葉書みたいだね」" } },
  "la hermana": {
    nuance: "「姉/妹」の基本語。年上・年下の区別なくhermanaと呼び、必要ならhermana mayor/menorで区別する。",
    etymology: "ラテン語germana（実の、同じ両親の）の女性形に由来。",
    synonyms: [], derived: ["hermanastra（異父・異母姉妹）"],
    dialogue: { es: "— ¿Tienes hermanas?\n— Sí, tengo dos hermanas menores.", ja: "「姉妹いる？」「うん、妹が2人いるよ」" } },
  "el abuelo": {
    nuance: "「祖父」。abuelosは「祖父母」という意味にもなる（男女混合の複数形）。",
    etymology: "ラテン語aviolus（avus「祖父」の指小形）に由来。",
    synonyms: [], derived: ["bisabuelo（曽祖父）", "abuelito（おじいちゃん、親しみを込めて）"],
    dialogue: { es: "— Mi abuelo cumple 80 años.\n— ¡Qué gran celebración le espera!", ja: "「祖父が80歳になるんだ」「それは盛大なお祝いになりそうだね！」" } },
  "la abuela": {
    nuance: "「祖母」。abuelitaという指小形も、親しみを込めてよく使われる。",
    etymology: "ラテン語aviola（avia「祖母」の指小形）に由来。",
    synonyms: [], derived: ["bisabuela（曽祖母）", "abuelita（おばあちゃん）"],
    dialogue: { es: "— Mi abuela cocina increíble.\n— La mía también, extraño su comida.", ja: "「祖母の料理は最高なんだ」「私の祖母もだよ、その料理が恋しいよ」" } },
  "la hija": {
    nuance: "「娘」の基本語。呼びかけとして「hija」だけで親しみを込めて使われることもある。",
    etymology: "ラテン語filia（娘）に由来。",
    synonyms: [], derived: ["hijastra（継子・娘）", "ahijada（名付け子・娘）"],
    dialogue: { es: "— Mi hija empieza la escuela mañana.\n— Debe estar muy emocionada.", ja: "「娘が明日から学校が始まるんだ」「とてもわくわくしているだろうね」" } },
  "el tío": {
    nuance: "「おじ」。スペインの口語ではtío/tíaが「やつ、あいつ」のようなくだけた呼びかけ語にもなる（メキシコではあまり使わない）。",
    etymology: "ラテン語thius（ギリシャ語theios由来）に由来。",
    synonyms: [], derived: ["tío abuelo（大おじ）"],
    dialogue: { es: "— Mi tío vive en Guadalajara.\n— Qué bonita ciudad.", ja: "「私のおじはグアダラハラに住んでいるよ」「素敵な街だね」" } },
  "la tía": {
    nuance: "「おば」の基本語。",
    etymology: "ラテン語thia（女性形）に由来。",
    synonyms: [], derived: ["tía abuela（大おば）"],
    dialogue: { es: "— Mi tía siempre nos trae regalos.\n— Qué generosa.", ja: "「私のおばはいつもプレゼントを持ってきてくれるんだ」「なんて気前がいいんだろう」" } },
  "el primo": {
    nuance: "「いとこ(男)」。女性はprima。英語のcousinと違い性別で単語が分かれる。",
    etymology: "ラテン語primus（最初の→血縁関係を表す語に転じた）に由来。",
    synonyms: [], derived: ["primo hermano（第一いとこ、より近い関係を強調）"],
    dialogue: { es: "— Mi primo viene de visita este fin de semana.\n— Qué divertido, ¿de dónde viene?", ja: "「今週末いとこが遊びに来るんだ」「楽しそうだね、どこから来るの？」" } },
  "la prima": {
    nuance: "「いとこ(女)」の基本語。",
    etymology: "primoの女性形。",
    synonyms: [], derived: [],
    dialogue: { es: "— Mi prima y yo somos muy unidas.\n— Qué lindo tener esa relación.", ja: "「いとこと私はとても仲がいいんだ」「そういう関係があるのは素敵だね」" } },
  "el esposo": {
    nuance: "「夫」。maridoもほぼ同義でよく使われる（esposoの方がややフォーマルな響き）。",
    etymology: "ラテン語sponsus（誓約した人→配偶者）に由来。",
    synonyms: ["marido（夫、より口語的）"],
    derived: ["esposar（手錠をかける、という別の意味も）", "esposas（手錠、複数形で）"],
    dialogue: { es: "— Mi esposo cocina los fines de semana.\n— Qué suerte tienes.", ja: "「夫は週末に料理をしてくれるんだ」「それは幸運だね」" } },
  "la esposa": {
    nuance: "「妻」。mujerも文脈によっては「妻」の意味で使われる（口語）。",
    etymology: "esposoの女性形。",
    synonyms: ["mujer（妻、口語的）"],
    derived: [],
    dialogue: { es: "— Mi esposa trabaja en un hospital.\n— Qué importante labor.", ja: "「妻は病院で働いているんだ」「大切な仕事だね」" } },
  "el nieto": {
    nuance: "「孫息子」。nietosは「孫たち」という意味にもなる（男女混合）。",
    etymology: "ラテン語nepos（孫、甥）に由来。",
    synonyms: [], derived: ["bisnieto（ひ孫）"],
    dialogue: { es: "— Mi abuela adora a sus nietos.\n— Se nota, siempre habla de ustedes.", ja: "「祖母は孫たちをとても可愛がっているんだ」「わかるよ、いつも君たちの話をしているもの」" } },
  "la nieta": {
    nuance: "「孫娘」の基本語。",
    etymology: "nietoの女性形。",
    synonyms: [], derived: ["bisnieta（ひ孫娘）"],
    dialogue: { es: "— Soy la nieta mayor de la familia.\n— Debes tener muchas responsabilidades.", ja: "「私は家族で一番年上の孫娘なんだ」「色々責任がありそうだね」" } },
  "el sobrino": {
    nuance: "「甥」の基本語。",
    etymology: "ラテン語sobrinus（いとこ→後に甥・姪の意味に変化）に由来。",
    synonyms: [], derived: [],
    dialogue: { es: "— Mi sobrino cumple cinco años.\n— Qué edad tan bonita.", ja: "「甥が5歳になるんだ」「かわいい年齢だね」" } },
  "la sobrina": {
    nuance: "「姪」の基本語。",
    etymology: "sobrinoの女性形。",
    synonyms: [], derived: [],
    dialogue: { es: "— Mi sobrina es muy inteligente.\n— Se nota que la quieres mucho.", ja: "「姪はとても賢いんだ」「とても可愛がっているのが伝わってくるね」" } },
  "el suegro": {
    nuance: "「義父」の基本語。suegrosは「義理の両親」という意味にもなる。",
    etymology: "ラテン語socer（義父）に由来。",
    synonyms: [], derived: ["consuegro（子供の配偶者の親同士の関係）"],
    dialogue: { es: "— Mi suegro es muy amable conmigo.\n— Qué bueno, no todos tienen esa suerte.", ja: "「義父は私にとても優しいんだ」「それはいいね、みんながその幸運に恵まれているわけではないから」" } },
  "la suegra": {
    nuance: "「義母」。スペイン語圏でもsuegraにまつわるジョークや慣用表現が多い（日本語の「姑」のイメージに近い）。",
    etymology: "suegroの女性形。",
    synonyms: [], derived: [],
    dialogue: { es: "— Mi suegra vive cerca de nosotros.\n— ¿Y se llevan bien?", ja: "「義母は私たちの近くに住んでいるんだ」「仲は良いの？」" } },
  "el cuñado": {
    nuance: "「義理の兄弟」。配偶者の兄弟、または自分の兄弟の配偶者を指す。女性形はcuñada。",
    etymology: "ラテン語cognatus（血縁関係のある）に由来。",
    synonyms: [], derived: ["cuñada（義理の姉妹）"],
    dialogue: { es: "— Mi cuñado es muy gracioso.\n— Las reuniones familiares deben ser divertidas.", ja: "「義理の兄弟はとても面白い人なんだ」「家族の集まりは楽しそうだね」" } },
};
